...
const Dashboard = () => {
  ...
  return (
    <div className="  w-full pt-20 px-4 pb-8" >
      <h1 className="text-4xl font-bold mb-4 text-pink-600">Covid Cases Chart</h1>
      ...
      <h1 className="text-4xl font-bold mb-4 mt-4 text-blue-500">Covid Cases World Map</h1>
      <div
